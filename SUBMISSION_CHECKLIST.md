...
## Скриншоты / видео
UI приложения — приложить `docs/PROOF.md` (файл `ui.png`) или ссылку
Grafana dashboard с данными — приложить `docs/PROOF.md` (файл `grafana-dashboard.png`) или ссылку
Loki logs — приложить `docs/PROOF.md` (файл `loki-logs.png`) или ссылку
Sentry error — приложить `docs/PROOF.md` (файл `sentry-issue.png`) или ссылку
